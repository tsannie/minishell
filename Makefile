...
#    Updated: 2021/03/23 15:51:40 by tsannie          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC			= main.c start_sh.c ft_cd.c ft_echo.c ft_env.c ft_export.c ft_exit.c \
...
ft_redirection.c shlvl.c ft_splitbc.c pipe.c lib.c exportpe.c ft_correct.c \
